...
--
-- Table structure for table `transakcija_copy`
--

DROP TABLE IF EXISTS `transakcija_copy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `transakcija_copy` (
  `IdT` int NOT NULL,
  `IdR` int NOT NULL,
